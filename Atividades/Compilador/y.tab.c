...
{
      -5,    -1,     2,    17,    -8,     6,    18,    21,    -8,    -8,
      -8,    16,    21,    -7,    -8,    -8,    21,    -8,    21,    21,
      21,    21,     7,    -3,    -3,    -3,    -3
};
...
{
      16,     1,     4,     3,    16,    17,    18,    19,    20,    21,
      18,    19,    20,    21,    22,     6,    23,    24,    25,    26,
      18,    19,    20,    21,     9,     5,    10,    14,     7,     0,
       0,    15
};

static const yytype_int8 yycheck[] =
{
       7,     6,     0,     4,     7,    12,    13,    14,    15,    16,
      13,    14,    15,    16,    16,     9,    18,    19,    20,    21,
      13,    14,    15,    16,     3,     8,     5,    11,    10,    -1,
      -1,    12
};
...
{
       0,     6,    18,     4,     0,     8,     9,    10,    19,     3,
       5,    20,    21,    22,    11,    20,     7,    12,    13,    14,
      15,    16,    22,    22,    22,    22,    22
};
...
#line 87 "sintatica.y"
                        {
				yyval.label = genLabel();
				yyval.traducao = "\tnum " +yyval.label + " = " + yyvsp[0].traducao + ";\n";
			}
#line 1240 "y.tab.c"
    break;
...
#line 92 "sintatica.y"
                        {
				yyval.label = genLabel();
				yyval.traducao = "\tid " + yyval.label + " = " + yyvsp[0].label + ";\n";
			}
#line 1249 "y.tab.c"
    break;
